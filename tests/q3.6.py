...
test = {   'name': 'q3.6',
    'points': 7,
    'suites': [   {   'cases': [   {   'code': '>>> type(joints_36) is list and len(joints_36) == 7\nTrue',
                                   ...
                                   {   'code': ">>> joint_ids = [mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_JOINT, f'panda_joint{i + 1}') for i in range(7)]\n"
                                               '>>> all((joints_36[i] >= model.jnt_range[joint_ids[i], 0] and joints_36[i] <= model.jnt_range[joint_ids[i], 1] for i in range(7)))\n'
                                               'True',
